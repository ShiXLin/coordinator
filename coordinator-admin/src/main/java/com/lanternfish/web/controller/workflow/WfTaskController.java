...
public class WfTaskController {
     ...
     */
    @PutMapping("/addSign")
    public R addSign(@RequestBody WfTaskAddSign bo) {
        flowTaskService.addSign(bo);
        return R.ok();
    }
     ...
     * 生成加签测试用例
     */
    @GetMapping("/getAddSignTestDemo")
    public R getAddSignTestDemo() {
        return flowTaskService.getAddSignTestDemo();
    }

    /**
     * batch back task
     */
    @PutMapping("/batchBackTask")
    public R batchBackTask(@RequestBody String[] backString) {
        flowTaskService.batchBackTask(Arrays.asList(backString));
        return R.ok();
    }
}
