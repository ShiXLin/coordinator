  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>RuoYi-Nbcio后台管理框架</h2>
        <p>
          RuoYi-Nbcio 是基于 RuoYi-Flowable-Plus
          <br/>
        ...
        <p>
          <el-button
            ...
            icon="el-icon-cloudy"
            plain
            @click="goTarget('https://gitee.com/nbacheng/ruoyi-nbcio')"
            >访问码云</el-button
          >
          <el-button
            type="primary"
            ...
            icon="el-icon-cloudy"
            plain
            @click="goTarget('https://gitee.com/nbacheng/ruoyi-nbcio/wikis/pages?sort_id=4106467&doc_id=1469725')"
          >更新日志</el-button
          >
        </p>
      </el-col>
